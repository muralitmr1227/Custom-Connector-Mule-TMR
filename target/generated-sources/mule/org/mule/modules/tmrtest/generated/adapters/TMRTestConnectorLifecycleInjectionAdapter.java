...
/**
 * A <code>TMRTestConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link TMRTestConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-05-31T12:59:16+05:30", comments = "Build UNNAMED.2793.f49b6c7")
public class TMRTestConnectorLifecycleInjectionAdapter
    extends TMRTestConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(TMRTestConnectorLifecycleInjectionAdapter.class);
